...
<div class="tarot-app" id="tarotApp">
  <header class="tarot-header">
    <h1><span class="tarot-icon tarot-icon--lg" id="headerIcon" aria-hidden="true"></span>Tirada de las 3 Cartas</h1>
  ...
  <section class="mode-step" id="modeStep">
    ...
    <div class="mode-options">
      <button type="button" class="mode-card" data-mode="digital">
        <span class="tarot-icon tarot-icon--sm" id="modeDigitalIcon" aria-hidden="true"></span>
      ...
      <button type="button" class="mode-card" data-mode="fisica">
        <span class="tarot-icon tarot-icon--sm" id="modeFisicaIcon" aria-hidden="true"></span>
        <h3>Tirada física</h3>
  ...
  <section class="reading" id="readingSection" hidden>
    <h2><span class="tarot-icon tarot-icon--md" id="readingIcon" aria-hidden="true"></span>Tu lectura</h2>
